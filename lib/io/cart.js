...
const ROM_BANK_COUNT = [];

ROM_BANK_COUNT[0x00] = 0;
ROM_BANK_COUNT[0x01] = 4;
ROM_BANK_COUNT[0x02] = 8;
ROM_BANK_COUNT[0x03] = 16;
ROM_BANK_COUNT[0x04] = 32;
ROM_BANK_COUNT[0x05] = 64;
ROM_BANK_COUNT[0x06] = 128;
ROM_BANK_COUNT[0x07] = 256;
ROM_BANK_COUNT[0x52] = 72;
ROM_BANK_COUNT[0x53] = 80;
ROM_BANK_COUNT[0x54] = 96;

const ROM_BANK_SIZE = 0x4000;
const ROM_SIZE = [];

ROM_SIZE[0x00] = 0x8000;
ROM_SIZE[0x01] = ROM_BANK_SIZE * ROM_BANK_COUNT[0x01];
ROM_SIZE[0x02] = ROM_BANK_SIZE * ROM_BANK_COUNT[0x02];
ROM_SIZE[0x03] = ROM_BANK_SIZE * ROM_BANK_COUNT[0x03];
ROM_SIZE[0x04] = ROM_BANK_SIZE * ROM_BANK_COUNT[0x04];
ROM_SIZE[0x05] = ROM_BANK_SIZE * ROM_BANK_COUNT[0x05];
ROM_SIZE[0x06] = ROM_BANK_SIZE * ROM_BANK_COUNT[0x06];
ROM_SIZE[0x07] = ROM_BANK_SIZE * ROM_BANK_COUNT[0x07];
ROM_SIZE[0x52] = ROM_BANK_SIZE * ROM_BANK_COUNT[0x52];
ROM_SIZE[0x53] = ROM_BANK_SIZE * ROM_BANK_COUNT[0x53];
ROM_SIZE[0x54] = ROM_BANK_SIZE * ROM_BANK_COUNT[0x54];
...
class Cart extends Serializable({ exclude: ['_rom'] }) {
    constructor (data) {
        ...
        this._rom = new Uint8Array(ROM_SIZE[this._romSize]);
    ...
    writeByte (addr, val) {
        switch (addr >> 12) {
            ...
            case 0x2: case 0x3: {
                ...
                const mask = ROM_BANK_COUNT[this._romSize] - 1;
