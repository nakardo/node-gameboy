...
const debugRead = require('debug')('mmu:read');
const debugWrite = require('debug')('mmu:write');
...
class Mmu {
    ...
    readByte (pos) {
        debugRead('reading $%s', pos.toString(16));
    ...
    writeByte (pos, value) {
        debugWrite('writing byte $%s', pos.toString(16));
