...
Mmu.prototype.powerOn = function () {
    ...
    this._hreg = new Uint8Array(0x7F);
...
Mmu.prototype.readByte = function (addr) {
    ...
    switch (addr & 0xF000) {
        ...
        case 0xF000:
            ...
            if (addr < 0xFE00) return this._wram[addr - 0xFDFF];
            ...
            switch (addr & 0xFF00) {
                ...
                case 0xFF00:
                    ...
                    else if (addr < 0xFF80) return this._hreg[addr - 0xFF00];
            ...
            switch (addr & 0xFF00) {
                ...
                case 0xFF00:
                    ...
                    // $FF00-$FF7F  Hardware I/O Registers
                        ...
                        var effective = addr - 0xFF00;
                        var current = this._hreg[effective];
                        var updated = this._hreg[effective] = value;

                        this.emit('hreg_update', addr, effective, current,
                            updated);
