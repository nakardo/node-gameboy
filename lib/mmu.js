...
class Mmu extends Serializable({ exclude }) {
    ...
    fromJSON (obj) {
        ...
        this._wram0 = new Uint8Array(obj._wram0);
        this._wram1 = new Uint8Array(obj._wram1);
    ...
    readByte (addr) {
        ...
        switch (addr >> 12) {
            ...
            case 0xc:
                return this._wram0[addr & 0x1fff];
            case 0xd:
                return this._wram1[addr & 0x1fff];
            case 0xe: case 0xf:
    ...
    writeByte (addr, val) {
        ...
        switch (addr >> 12) {
            ...
            case 0xc:
                return this._wram0[addr & 0x1fff] = val;
            case 0xd:
                return this._wram1[addr & 0x1fff] = val;
            case 0xe: case 0xf:
