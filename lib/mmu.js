...
const { DIV, TAC, TMA, TIMA, IE, IF } = require('./registers');
    ...
    readByte (pos) {
        ...
        switch (pos & 0xf000) {
            ...
            case 0xf000:
                ...
                else if (pos > 0xff7f) return this._zram[pos - 0xff80];
                else switch (pos) {
                    case 0xff50: return this._isBiosDisabled;
    ...
    writeByte (pos, value) {
        ...
        switch (pos & 0xf000) {
            ...
            case 0xf000:
                ...
                else if (pos > 0xff7f) return this._zram[pos - 0xff80] = value;
                else switch (pos) {
                    case 0xff50: return this._isBiosDisabled = value;
                    case TAC: return this.timer.tac = value;
                    case TMA: return this.timer.tma = value;
                    case TIMA: return this.timer.tima = value;
                    case DIV: return this.timer.div = value;
                }
