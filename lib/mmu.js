    ...
    readByte (pos) {
        ...
        switch (pos & 0xf000) {
            ...
            case 0xf000:
                ...
                else if (pos >= 0xfea0) return 0;
                else if (pos >= 0xfe00) return this._oam[pos - 0xfe00];
    ...
    writeByte (pos, value) {
        ...
        switch (pos & 0xf000) {
            ...
            case 0xf000:
                ...
                else if (pos >= 0xfea0) return value;
                else if (pos >= 0xfe00) return this._oam[pos - 0xfe00] = value;
