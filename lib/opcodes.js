...
$[0x20] = ['JR NZ,n', (cpu, mmu) => JR_cc_n(!(cpu.f & FLAG_Z), cpu, mmu)];
$[0x30] = ['JR NC,n', (cpu, mmu) => JR_cc_n(!(cpu.f & FLAG_C), cpu, mmu)];
...
$[0xc4] = ['CALL NZ,nn', (cpu, mmu) => CALL_cc_nn(!(cpu.f & FLAG_Z), cpu, mmu)];
$[0xd4] = ['CALL NC,nn', (cpu, mmu) => CALL_cc_nn(!(cpu.f & FLAG_C), cpu, mmu)];
...
$[0xc0] = ['RET NZ', (cpu, mmu) => RET_cc(!(cpu.f & FLAG_Z), cpu, mmu)];
$[0xd0] = ['RET NC', (cpu, mmu) => RET_cc(!(cpu.f & FLAG_C), cpu, mmu)];
