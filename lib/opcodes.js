...
$[0x8e] = ['ADC A,(HL)', (cpu, mmu) => {
    const v = cpu.a + mmu.readByte(cpu.hl) + cpu.f >> 4 & 1;
    cpu.a = v;
...
$[0xce] = ['ADC A,#', (cpu, mmu) => {
    const v = cpu.a + mmu.readByte(cpu.pc + 1) + cpu.f >> 4 & 1;
    cpu.a = v;
