...
const BIT_b_r = (b, r, cpu) => {
    cpu.f &= ~0xe0;
    if (!(cpu[r] & cpu[r] << b)) cpu.f |= 1 << 7;
    cpu.f |= 1 << 5;
...
$cb[0x47] = ['BIT 0,A', (...args) => BIT_b_r(0, 'a', ...args)];
$cb[0x4f] = ['BIT 1,A', (...args) => BIT_b_r(1, 'a', ...args)];
$cb[0x57] = ['BIT 2,A', (...args) => BIT_b_r(2, 'a', ...args)];
$cb[0x5f] = ['BIT 3,A', (...args) => BIT_b_r(3, 'a', ...args)];
$cb[0x67] = ['BIT 4,A', (...args) => BIT_b_r(4, 'a', ...args)];
$cb[0x6f] = ['BIT 5,A', (...args) => BIT_b_r(5, 'a', ...args)];
$cb[0x77] = ['BIT 6,A', (...args) => BIT_b_r(6, 'a', ...args)];
$cb[0x7f] = ['BIT 7,A', (...args) => BIT_b_r(7, 'a', ...args)];

$cb[0x40] = ['BIT 0,B', (...args) => BIT_b_r(0, 'b', ...args)];
$cb[0x48] = ['BIT 1,B', (...args) => BIT_b_r(1, 'b', ...args)];
$cb[0x50] = ['BIT 2,B', (...args) => BIT_b_r(2, 'b', ...args)];
$cb[0x58] = ['BIT 3,B', (...args) => BIT_b_r(3, 'b', ...args)];
$cb[0x60] = ['BIT 4,B', (...args) => BIT_b_r(4, 'b', ...args)];
$cb[0x68] = ['BIT 5,B', (...args) => BIT_b_r(5, 'b', ...args)];
$cb[0x70] = ['BIT 6,B', (...args) => BIT_b_r(6, 'b', ...args)];
$cb[0x78] = ['BIT 7,B', (...args) => BIT_b_r(7, 'b', ...args)];

$cb[0x41] = ['BIT 0,C', (...args) => BIT_b_r(0, 'c', ...args)];
$cb[0x49] = ['BIT 1,C', (...args) => BIT_b_r(1, 'c', ...args)];
$cb[0x51] = ['BIT 2,C', (...args) => BIT_b_r(2, 'c', ...args)];
$cb[0x59] = ['BIT 3,C', (...args) => BIT_b_r(3, 'c', ...args)];
$cb[0x61] = ['BIT 4,C', (...args) => BIT_b_r(4, 'c', ...args)];
$cb[0x69] = ['BIT 5,C', (...args) => BIT_b_r(5, 'c', ...args)];
$cb[0x71] = ['BIT 6,C', (...args) => BIT_b_r(6, 'c', ...args)];
$cb[0x79] = ['BIT 7,C', (...args) => BIT_b_r(7, 'c', ...args)];

$cb[0x42] = ['BIT 0,D', (...args) => BIT_b_r(0, 'd', ...args)];
$cb[0x4a] = ['BIT 1,D', (...args) => BIT_b_r(1, 'd', ...args)];
$cb[0x52] = ['BIT 2,D', (...args) => BIT_b_r(2, 'd', ...args)];
$cb[0x5a] = ['BIT 3,D', (...args) => BIT_b_r(3, 'd', ...args)];
$cb[0x62] = ['BIT 4,D', (...args) => BIT_b_r(4, 'd', ...args)];
$cb[0x6a] = ['BIT 5,D', (...args) => BIT_b_r(5, 'd', ...args)];
$cb[0x72] = ['BIT 6,D', (...args) => BIT_b_r(6, 'd', ...args)];
$cb[0x7a] = ['BIT 7,D', (...args) => BIT_b_r(7, 'd', ...args)];

$cb[0x43] = ['BIT 0,E', (...args) => BIT_b_r(0, 'e', ...args)];
$cb[0x4b] = ['BIT 1,E', (...args) => BIT_b_r(1, 'e', ...args)];
$cb[0x53] = ['BIT 2,E', (...args) => BIT_b_r(2, 'e', ...args)];
$cb[0x5b] = ['BIT 3,E', (...args) => BIT_b_r(3, 'e', ...args)];
$cb[0x63] = ['BIT 4,E', (...args) => BIT_b_r(4, 'e', ...args)];
$cb[0x6b] = ['BIT 5,E', (...args) => BIT_b_r(5, 'e', ...args)];
$cb[0x73] = ['BIT 6,E', (...args) => BIT_b_r(6, 'e', ...args)];
$cb[0x7b] = ['BIT 7,E', (...args) => BIT_b_r(7, 'e', ...args)];

$cb[0x44] = ['BIT 0,H', (...args) => BIT_b_r(0, 'h', ...args)];
$cb[0x4c] = ['BIT 1,H', (...args) => BIT_b_r(1, 'h', ...args)];
$cb[0x54] = ['BIT 2,H', (...args) => BIT_b_r(2, 'h', ...args)];
$cb[0x5c] = ['BIT 3,H', (...args) => BIT_b_r(3, 'h', ...args)];
$cb[0x64] = ['BIT 4,H', (...args) => BIT_b_r(4, 'h', ...args)];
$cb[0x6c] = ['BIT 5,H', (...args) => BIT_b_r(5, 'h', ...args)];
$cb[0x74] = ['BIT 6,H', (...args) => BIT_b_r(6, 'h', ...args)];
$cb[0x7c] = ['BIT 7,H', (...args) => BIT_b_r(7, 'h', ...args)];
