...
Object.defineProperty(Cpu.prototype, 'z', {
    get: function () {
        return (this.f & 0x80) >> 7;
    },
    set: function (value) {
        return value ? this.f |= 0x80 : this.f &= ~(1 << 0x80);
    }
});

Object.defineProperty(Cpu.prototype, 'n', {
    get: function () {
        return (this.f & 0x40) >> 6;
    },
    set: function (value) {
        return value ? this.f |= 0x40 : this.f &= ~(1 << 0x40);
    }
});

Object.defineProperty(Cpu.prototype, 'h', {
    get: function () {
        return (this.f & 0x20) >> 5;
    },
    set: function (value) {
        return value ? this.f |= 0x20 : this.f &= ~(1 << 0x20);
    }
});

Object.defineProperty(Cpu.prototype, 'c', {
    get: function () {
        return (this.f & 0x10) >> 4;
    },
    set: function (value) {
        return value ? this.f |= 0x10 : this.f &= ~(1 << 0x10);
    }
});
