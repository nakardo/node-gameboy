...
class Cpu {
    ...
    _handleInts () {
         ...
         */
        const enabled = this._mmu.readWord(0xffff);
        if (enabled == 0) return;
         ...
         */
         const flags = this._mmu.readWord(0xff0f);

         if (flags & 1) return this._pc = 0x40;
         if (flags >> 1 & 1) return this._pc = 0x48;
         if (flags >> 2 & 1) return this._pc = 0x50;
         if (flags >> 3 & 1) return this._pc = 0x58;
         if (flags >> 4 & 1) return this._pc = 0x60;
    }
