...
const debugCycle = require('debug')('cpu:cycle');
const debugInt = require('debug')('cpu:int');
...
class Cpu {
    ...
    _handleInterrupts () {
         ...
         */
         ...
         debugInt('flags 0b%s', intf.toString(2));
         ...
         mmu.writeWord(this._sp -= 2, this._pc);
    ...
    _runCycle () {
        ...
        debugCycle('%s; $%s', inst[0], this.pc.toString(16));
