        ...
        switch (addr >> 12) {
            case 0x8: case 0x9:
                switch (addr >> 8) {
                    ...
                    case 0x97:
                        addr &= 0x1fff;
                        const idx = Math.floor(addr / 32);
                        const res = this._sumBytes(val, this._ram[addr + 1]);
                        this._tiles[idx][pos % 8] = res;
                        break;
                    case 0x98: case 0x99:
                    case 0x9a: case 0x9b:
                        this._bgmap[0][addr & 0x7ff] = this._tiles[val];
                        break;
                    case 0x9c: case 0x9d:
                    case 0x9e: case 0x9f:
                        this._bgmap[1][addr & 0xbff] = this._tiles[val];
                        break;
                }
