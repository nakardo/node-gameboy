...
const MAX_FRAME_CYCLES_CGB = 140000;
...
class Cpu extends Serializable({ exclude }) {
    constructor (mmu, timer, lcd) {
        ...
        this._loop = null;
        this._maxFrameCycles = MAX_FRAME_CYCLES;
        this.ime = false;
    ...
    start () {
        debug('start');
        this._maxFrameCycles = this._mmu.onDoubleSpeed()
            ? MAX_FRAME_CYCLES_CGB
            : MAX_FRAME_CYCLES;
    ...
    _step () {
        ...
        while (frameCycles < this._maxFrameCycles) {
