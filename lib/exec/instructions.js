...
after(function (cpu, spec) {
    ...
    ['z', 'n', 'h', 'c'].forEach(function (flag, i) {
        ...
        if (!isNaN(value)) that.flag(flag, value);
    });
...
inst('dec', function (cpu, op1) {
    ...
    if (op1.operand === 'hl') value = (op1() - 1) & 0xFFFF;
    else value = (op1() - 1) & 0xFF;
...
inst('bit', function (cpu, op1, op2) {
    ...
    return this.flag('z', ((1 << op1()) & op2()) === 0);
});
